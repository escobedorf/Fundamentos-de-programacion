...
${OBJECTDIR}/Factorial_recursivo.o: Factorial_recursivo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Factorial_recursivo.o Factorial_recursivo.c
...
${OBJECTDIR}/Fibonaccil_recursivo.o: Fibonaccil_recursivo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Fibonaccil_recursivo.o Fibonaccil_recursivo.c
...
${OBJECTDIR}/GuardarDatos.o: GuardarDatos.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GuardarDatos.o GuardarDatos.c
...
${OBJECTDIR}/Torre-de-Hanoi_recursivo.o: Torre-de-Hanoi_recursivo.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Torre-de-Hanoi_recursivo.o Torre-de-Hanoi_recursivo.c

${OBJECTDIR}/abecedario.o: abecedario.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/abecedario.o abecedario.c
...
${OBJECTDIR}/c22-menu\ de\ funciones\ matematicas-fail.o: c22-menu\ de\ funciones\ matematicas-fail.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/c22-menu\ de\ funciones\ matematicas-fail.o c22-menu\ de\ funciones\ matematicas-fail.c
...
${OBJECTDIR}/cadenasyarrays2.o: cadenasyarrays2.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cadenasyarrays2.o cadenasyarrays2.c

.NO_PARALLEL:${OBJECTDIR}/funciones\ en\ c.o
${OBJECTDIR}/funciones\ en\ c.o: funciones\ en\ c.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/funciones\ en\ c.o funciones\ en\ c.c
...
${OBJECTDIR}/funciones2.h.gch: funciones2.h
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o "$@" funciones2.h
...
${OBJECTDIR}/longitud\ de\ una\ cadena\ de\ texto.o: longitud\ de\ una\ cadena\ de\ texto.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/longitud\ de\ una\ cadena\ de\ texto.o longitud\ de\ una\ cadena\ de\ texto.c
